...
#include <sparc/asm.hxx>
#include <sparc/handlers.hxx>
#include <storage.hxx>
#include <printf.hxx>
#include <timeshr.hxx>
...
extern "C" {
	...
	SECTION(".head.text") NAKED_FUNC void start() noexcept
	{
		...
		for(register uint_fast16_t *ptr = &bss_start[0]; reinterpret_cast<uintptr_t>(ptr) < reinterpret_cast<uintptr_t>(&bss_end[0]); ptr++)
			*ptr = 0;
